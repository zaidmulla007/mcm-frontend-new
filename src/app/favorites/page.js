...
export default function FavoritesPage() {
  ...
  const handleRemoveFavorite = async (channelId, medium) => {
    ...
    try {
      ...
      if (response.success) {
        // Remove influencer from local state without re-fetching
        setFavoritesData(prev => prev.filter(fav => fav.favouriteId !== channelId));
  ...
  const handleRemoveCoinFavorite = async (coinId) => {
    ...
    try {
      ...
      if (data.success) {
        // Remove coin from local state without re-fetching
        setFavoritesData(prev => prev.filter(fav => fav.favouriteId !== coinId));
    ...
    <div className="min-h-screen bg-gradient-to-br from-cyan-50 via-indigo-50 to-fuchsia-50 text-gray-900 font-sans pb-16 overflow-x-hidden relative">
      ...
      <div className="max-w-5xl mx-auto px-4 relative z-10">
        <section className="pt-8 pb-6 flex flex-col items-center gap-6">
          ...
          <div className="w-32 h-1.5 bg-gradient-to-r from-cyan-500 to-indigo-500 rounded-full shadow-lg shadow-indigo-500/50"></div>
        </section>
            ...
            {tabs.map((tab) => (
              <button
                ...
                className={`px-8 py-3.5 rounded-xl text-sm font-bold transition-all duration-300 flex items-center gap-3 shadow-lg ${activeTab === tab.value
                  ? 'bg-gradient-to-r from-cyan-500 to-indigo-500 text-white shadow-indigo-500/30 scale-105'
                ...
                <div className="bg-gradient-to-br from-white/80 via-indigo-50/60 to-fuchsia-50/60 backdrop-blur-md rounded-3xl shadow-2xl shadow-indigo-500/10 border-2 border-white/40 overflow-hidden">
                  <div className="overflow-x-auto">
                    <table className="w-full">
                      <thead className="bg-gradient-to-r from-cyan-500 to-indigo-500 text-white">
                        <tr>
                          ...
                          >
                            ...
                            <td className="px-6 py-4">
                              {inf.channel_thumbnails?.high?.url ? (
                                ...
                                <div className="w-14 h-14 rounded-full bg-gradient-to-br from-cyan-500 to-indigo-500 flex items-center justify-center text-white font-bold shadow-lg ring-2 ring-indigo-200/50 ring-offset-2">
                            ...
                            <td className="px-6 py-4">
                              <div className="flex items-center justify-center gap-3">
                                <Link
                                  ...
                                  className="inline-flex items-center gap-2 px-5 py-2.5 bg-gradient-to-r from-cyan-500 to-indigo-500 text-white text-sm font-bold rounded-lg hover:from-cyan-600 hover:to-indigo-600 transition-all duration-300 shadow-lg hover:shadow-xl hover:scale-105"
                                >
                                  View Dashboard
                                </Link>
                                <button
                            ...
                            <td className="px-6 py-4">
                              <div className="flex items-center justify-center gap-3">
                                <Link
                                  ...
                                  className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-cyan-500 to-indigo-500 text-white text-sm font-semibold rounded-lg hover:from-cyan-600 hover:to-indigo-600 transition-all duration-200 shadow-md hover:shadow-lg"
                                >
                                  View Details
                                </Link>
                                <button
