...
export async function GET(request) {
  try {
    ...
    const externalUrl = `https://mcmapi.showmyui.com:3034/api/admin/telegramdata/ranking?sentiment=${sentiment}&timeframe=${timeframe}&type=${type}&year=${year}&quarter=${quarter}`;
