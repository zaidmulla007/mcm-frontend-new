    ...
    <div className="bg-gradient-to-br from-white/80 via-indigo-50/60 to-fuchsia-50/60 backdrop-blur-md rounded-3xl shadow-2xl shadow-indigo-500/10 border-2 border-white/40 mb-6 overflow-hidden">
      <div className="border-b border-indigo-200/30 bg-gradient-to-r from-cyan-50/50 to-fuchsia-50/50 px-6 py-4">
        <h3 className="text-lg font-semibold">
          <span className="bg-gradient-to-r from-cyan-500 to-indigo-500 bg-clip-text text-transparent">Top Crypto News & Stories</span>
        </h3>
      </div>
...
function TradingViewEconomicCalendar() {
  ...
  return (
    <div className="bg-gradient-to-br from-white/80 via-indigo-50/60 to-fuchsia-50/60 backdrop-blur-md rounded-3xl shadow-2xl shadow-indigo-500/10 border-2 border-white/40 mb-6 overflow-hidden">
      <div className="border-b border-indigo-200/30 bg-gradient-to-r from-cyan-50/50 to-fuchsia-50/50 px-6 py-4">
        <h3 className="text-lg font-semibold">
          <span className="bg-gradient-to-r from-cyan-500 to-indigo-500 bg-clip-text text-transparent">Economic Calendar</span>
        </h3>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="mb-8">
            <h1 className="text-4xl md:text-5xl font-bold">
              <span className="bg-gradient-to-r from-cyan-500 to-indigo-500 bg-clip-text text-transparent">Top News & Economic Events</span>
            </h1>
            <div className="mt-5">
