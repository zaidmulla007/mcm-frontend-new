...
import YouTubeTelegramDataTable2 from "../components/YoutubeTelegramDataTable2";
      ...
      {isLocked && !isRegistered && (
        <div className="absolute inset-0 bg-white/95 backdrop-blur-lg rounded-3xl flex flex-col items-center justify-center z-20 p-6">
          <div className="text-center">
            ...
            <Link href="/login">
              <motion.button
                className="bg-gradient-to-r from-cyan-500 to-indigo-500 hover:from-cyan-700 hover:via-indigo-700 hover:to-fuchsia-700 px-8 py-3 rounded-xl font-bold text-white shadow-lg shadow-indigo-500/30 transition-all duration-200 w-full"
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-cyan-50 via-indigo-50 to-fuchsia-50 text-gray-900 font-sans pb-16 overflow-x-hidden relative">
      ...
      <div className="mt-7 relative z-10">
        <div className="w-full items-start mb-4 px-8">
      ...
      <section id="trending" className="mx-auto px-4 pt-0 pb-6 relative z-10">
        ...
        >
          ...
          <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4 mb-2">
            ...
            <div className="w-full items-start px-2">
              <h2 className="text-4xl md:text-5xl font-bold flex items-center gap-3 drop-shadow-sm">
                ...
                <Link href="/coins-new" className="relative group/mcm">
                  <FaInfoCircle className="text-gray-500 text-sm cursor-pointer hover:text-indigo-600 transition-colors" />
              ...
              <div className="flex items-center gap-4 mt-1 mb-1">
                <div className="w-24 h-1 bg-gradient-to-r from-cyan-500 to-indigo-500 rounded-full flex-shrink-0 shadow-lg shadow-indigo-500/50"></div>
              </div>
            </div>
          ...
          <div className="mt-4">
            <YouTubeTelegramDataTable2 useLocalTime={useLocalTime} />
          </div>
