    ...
    <section className="max-w-7xl mx-auto px-4 py-12 relative z-10">
      ...
      >
        ...
        <div className="relative rounded-3xl p-8 md:p-16 text-center bg-white/95 backdrop-blur-xl overflow-hidden">
          ...
          {/* Content */}
          <motion.h2
            className="text-4xl md:text-6xl font-extrabold mb-6 bg-gradient-to-r from-cyan-500 to-indigo-500 bg-clip-text text-transparent drop-shadow-sm leading-normal pb-2"
            initial={{ opacity: 0, y: 10 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            transition={{ duration: 0.5, delay: 0.2 }}
          >
            Choose Your Influencer Responsibly
          </motion.h2>
          ...
          >
            ...
            <span className="font-bold bg-gradient-to-r from-indigo-500 to-fuchsia-500 bg-clip-text text-transparent">
              real-time influencer performance information
            </span>
          </motion.p>
          ...
          >
            <Link href="/login?signup=true">
              <motion.button
                className="group relative bg-gradient-to-r from-cyan-500 to-indigo-500 text-white px-12 py-5 rounded-2xl font-bold text-xl shadow-xl shadow-indigo-500/30 overflow-hidden"
