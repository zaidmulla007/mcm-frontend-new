          ...
          <div className="mt-3 flex flex-wrap justify-start gap-4 text-sm text-black">
            {(channelData?.videos_last_30_count !== undefined && channelData?.videos_last_30_count !== null) && (
              <div className="flex items-start gap-2">
                ...
                <span className="font-semibold text-black bg-blue-100 px-3 py-1 rounded-full">{channelData.videos_last_30_count} videos</span>
              </div>
            )}
            {(channelData?.videos_last_7_count !== undefined && channelData?.videos_last_7_count !== null) && (
              <div className="flex items-start gap-2">
                <span className="text-black">Last 7 days:</span>
                <span className="font-semibold text-black bg-green-100 px-3 py-1 rounded-full">{channelData.videos_last_7_count} videos</span>
              </div>
            )}
            {(channelData?.videos_last_24h_count !== undefined && channelData?.videos_last_24h_count !== null) && (
              <div className="flex items-start gap-2">
                ...
                <span className="font-semibold text-black bg-purple-100 px-3 py-1 rounded-full">{channelData.videos_last_24h_count} videos</span>
              </div>
            )}
          </div>
          {/* {rank && (
            ...
            <>
              ...
              {canScrollLeft && (
                <button
                  ...
                  className="absolute left-0 top-1/2 -translate-y-1/2 z-10 bg-white/90 hover:bg-white shadow-lg border border-gray-200 rounded-full w-10 h-10 flex items-center justify-center text-indigo-600 hover:text-indigo-800 transition-all duration-200 cursor-pointer"
              ...
              {canScrollRight && (
                <button
                  onClick={() => scrollByCard(1)}
                  className="absolute right-0 top-1/2 -translate-y-1/2 z-10 bg-white/90 hover:bg-white shadow-lg border border-gray-200 rounded-full w-10 h-10 flex items-center justify-center text-indigo-600 hover:text-indigo-800 transition-all duration-200 cursor-pointer"
            ...
            >
              ...
              <div className="p-3 border-b border-gray-800">
                <div className="min-h-[40px] mb-2">
                  <div className={`text-sm font-medium text-black ${expandedTitles[post.id] ? '' : 'line-clamp-2'}`} title={post.title}>
                    {post.title}
                  </div>
                </div>
                    ...
                    <table className="w-full text-xs">
                      <thead>
                        <tr className="border-b border-gray-800">
                          ...
                          <th className="text-center text-black pb-1">Outlook</th>
                        </tr>
                      </thead>
                      <tbody>
                        {(() => {
