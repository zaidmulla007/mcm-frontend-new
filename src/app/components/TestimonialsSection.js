    ...
    <section className="max-w-7xl mx-auto px-4 py-16 relative z-10">
      ...
      >
        <h2 className="text-4xl md:text-6xl font-extrabold mb-4">
          <span className="bg-gradient-to-r from-cyan-500 to-indigo-500 bg-clip-text text-transparent drop-shadow-sm">
            What Our Users Say
          </span>
        </h2>
        ...
        <div className="w-32 h-1.5 bg-gradient-to-r from-cyan-500 to-indigo-500 mx-auto rounded-full shadow-lg shadow-indigo-500/30"></div>
      </motion.div>
          ...
          {testimonials.map((_, index) => (
            <button
              ...
              className={`rounded-full transition-all duration-300 ${currentIndex === index
                  ? 'w-12 h-3 bg-gradient-to-r from-cyan-500 to-indigo-500 shadow-lg shadow-indigo-500/30'
