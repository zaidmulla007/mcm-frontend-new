...
export default function YouTubeTelegramDataTable() {
    ...
    const fetchCombinedData = async () => {
        try {
            const response = await fetch('https://mcmapi.showmyui.com:3035/api/admin/youtubedata/ytandtg');
                                        ...
                                        <tr key={index} className="border-b border-gray-800 hover:bg-gradient-to-br hover:from-purple-900/20 hover:to-blue-900/20 transition-all duration-300">
                                            ...
                                            <td className="py-3 px-2 text-center">
                                                <div className="win-loss-container">
                                                    ...
                                                    {/* Value Text */}
                                                    <div className={`font-semibold text-sm ${isBullish ? 'text-green-500' : 'text-red-500'}`}>
