...
export default function ClientFooter() {
  ...
  useEffect(() => {
    ...
    // Listen for storage changes (cross-tab) and custom authChange (same-tab)
          ...
          <div className="bg-white rounded-2xl shadow-2xl shadow-indigo-500/10 w-full max-w-md max-h-[90vh] overflow-y-auto border border-indigo-200/50">
            ...
            <form onSubmit={handleContactSubmit} className="space-y-3 p-6">
              ...
              <div className="flex gap-3 pt-2">
                ...
                <button
                  type="submit"
                  className="flex-1 px-4 py-2 rounded-lg font-semibold bg-gradient-to-r from-cyan-500 to-indigo-500 hover:from-cyan-700 hover:via-indigo-700 hover:to-fuchsia-700 text-white hover:scale-105 transition shadow-lg shadow-indigo-500/30 text-sm"
                >
                  Send
                </button>
              </div>
