...
export default function MarketOverview() {
  const [activeView, setActiveView] = useState('screener'); // 'overview', 'screener', 'heatmap'
      ...
      <main className="mx-auto px-4 pb-8 pt-5 relative z-10">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-8">
            ...
            <div className="w-24 h-1 bg-gradient-to-r from-cyan-500 to-indigo-500 rounded-full shadow-lg shadow-indigo-500/50"></div>
          </div>

          {/* Toggle Buttons - Commented out, only showing Screener */}
